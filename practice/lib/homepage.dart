...
import 'package:infi_co/screens/email_auth/register.dart';
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    trailing: const CircleAvatar(
                      radius: 30,
                      backgroundImage: AssetImage('assets/finalimageinfi.jpg'),
                    ),
                  ),
              ...
              child: Container(
                ...
                child: GridView.count(
                  ...
                  children: [
                    ...
                    itemDashboard('Internships', CupertinoIcons.person_2,
                        Colors.purple, context),
                    itemDashboard('Comments', CupertinoIcons.chat_bubble_2,
                        Colors.brown, context),
                    itemDashboard('Quizzes', CupertinoIcons.money_dollar_circle,
                        Colors.indigo, context),
                    itemDashboard('Hackathon', CupertinoIcons.add_circled,
                        Colors.teal, context),
