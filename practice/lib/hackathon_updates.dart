...
class HackathonUpdatesPage extends StatelessWidget {
  final List<Hackathon> hackathons = [
    ...
    Hackathon(
      ...
      url: 'https://example.com/technest',
      type: 'Offline',
      icon: Icons.wifi,
    ),
    Hackathon(
      ...
      url: 'https://example.com/hackwave',
      type: 'Online',
      icon: Icons.waves,
    ),
    Hackathon(
      ...
      url: 'https://example.com/innohive',
      type: 'Offline',
      icon: Icons.api,
    ),
    Hackathon(
      ...
      url: 'https://example.com/datafrenzy',
      type: 'Online',
      icon: Icons.storage,
    ),
    Hackathon(
      ...
      url: 'https://example.com/hacksphere',
      type: 'Offline',
      icon: Icons.public,
    ),
    Hackathon(
      ...
      url: 'https://example.com/cyberquest',
      type: 'Online',
      icon: Icons.security,
    ),
    Hackathon(
      ...
      url: 'https://example.com/techtonic',
      type: 'Offline',
      icon: Icons.settings,
    ),
